...
<ul>
  ...
  <li><a href="./examples">Examples</a>
    <ul>
      ...
      <li>
        <a href="./examples/complete">Complete example with topics and schema creation.</a>
  ...
  <li><a href="./solutions">Deployable Architectures</a>
    <ul>
      <li><a href="./solutions/quickstart"> Cloud automation for Event Streams (quickstart)</a></li>
      <li><a href="./solutions/security-enforced"> Cloud automation for Event Streams (Security-enforced)</a></li>
    </ul>
  </li>
