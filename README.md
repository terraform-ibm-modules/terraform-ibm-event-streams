...
| <a name="input_schemas"></a> [schemas](#input\_schemas) | The list of schema objects. Include the `schema_id` and the schema definition. | <pre>list(object({<br/>    schema_id = string<br/>    schema    = any<br/>  }))</pre> | `[]` | no |
